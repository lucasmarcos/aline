      ...
      <Content>
        <BlocoEsquerda>
          ...
          <P>
            ...
            maneira segura, reconhecê-las, aceitá-las, e se necessário refletir
        ...
        <BlocoEsquerda>
          <P>
            ...
            respeito delas, ensinando inclusive como lidar com nossas próprias
            emoções e os sentimentos despertados por elas.
          </P>
        ...
        <BlocoDireta>
          ...
          <P>
            ...
            nossas formas de viver, ou sobre algo que elas possam nos dizer
            sobre nós, ou mesmo refletir em nossa saúde.
          </P>

          <P>
            Durante este ano iremos direcionar nosso olhar e reflexão para
            emoções básicas, inatas que não dependem, inicialmente, de fatores
        ...
        <BlocoDireta>
          <P>
            ...
            cercam, para que juntos possamos nos desenvolver, nos compreender, e
            também, termos relações cada vez mais saudáveis . Para começarmos
            esta jornada, escolhemos uma emoção que provavelmente é a emoção que
            nos une aqui na Universidade, a ALEGRIA! Aquela emoção que você
        ...
        <BlocoEsquerda>
          ...
          <P>
            A alegria, assim como outras emoções, é uma sensação passageira.
          </P>

          <P>
            E os sentimentos de felicidade, alimentados pela alegria, são
            únicos, possuem sentidos muito individuais e complexos, pois o que
        ...
        <BlocoDireta>
          <P>
            ...
            uns, mas para uma pessoa que possui problemas de pele, que não pode
            estar exposta ao sol, ou alergia a areia, essa cena pode ser

...
export const Raiva = () => {
  return (
    <Article>
      <ArticleHeader className="bg-red-500" title="Raiva" subtitle="Que emoção é essa?" />
      ...
      <Content>
        ...
        A raiva surge em situações em que nos

        deparamos com um obstáculo avaliado
        como hostil, que interfere no que se está
        fazendo ou intencionando a fazer. Essa
        emoção tende a mover de maneira a
        remover o impedimento e mudar a
        situação atual, frequentemente de modo
        que destrua ou prejudique o alvo, neste
        caso, o obstáculo (MIGUEL, p.158, 2015).
        “A raiva surge diante de algum obstáculo
        que nos frustra ou impede as nossas
        ações (...)Dessa forma, a raiva é a emoção

        que indica que algo está em nosso caminho
        nos prejudicando de algum modo e que,
        portanto, estaremos motivados para mudar o
        ambiente e retirar esse impedimento”
        (GONDIN, 2020, p. 79). Ainda, segundo Barros
        (2020, p.78) as situações que envolvem
        comportamentos de outras pessoas, são as
        situações que mais desencadeiam nossa raiva,
        pois nas situações consideradas como
        fatalidade ou como inevitáveis, tendemos a nos
        aborrecer menos.
        ...
        Essa é uma excelente função. O problema reside na forma como nos impulsiona e os comportamentos assumidos partindo dessa motivação, ou seja, posso reagir impulsivamente e agir “de cabeça quente” porque estou com raiva, ou essa raiva pode ser uma inquietude, que me faz pensar sobre meu problema e somente após isso, partir para alguma ação. A raiva, mesmo sendo despertada por diferentes motivos, seja quando nos sentimos ameaçados de perder algo, como status, autoridade, dominância, alguma coisa física e/ou simbólica, em situações em que percebemos que podemos ser prejudicados, ou seja, ela surge como um impulso de defesa sobre o que é nosso, ou sobre o que acreditamos ser nosso (BARROS, p. 77). São infinitas as situações que podem desencadear raiva, tendo em vista ser um aspecto muito pessoal, que diz respeito a individualidade e a singularidade de cada sujeito, tem uma tendência a fazer com que as pessoas processem as informações advindas do ambiente de forma mais rápida. Contudo, esse processamento não leva em conta todo o contexto, a raiva faz com que o sujeito crie um foco de atenção, mais relevante para ele naquele momento, ignorando outros fatores que poderiam ser relevantes para tomada de decisão (GONDIN, 2020).

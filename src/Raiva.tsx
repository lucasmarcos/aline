        ...
        <Content>
          ...
          <BlocoEsquerda>
            <P>
              ...
              Popularmente muito conhecida, a qual faz parte quase que
              diariamente do nosso vocabulário de expressões, tais como “nossa
              fui tomado de raiva”, “gente que raiva que me deu”, mas,
              arriscamos dizer que seja a emoção menos compreendida entre nós.
              Isso porque, a raiva, é a emoção com maior impacto negativo nas
              relações interpessoais, justamente, porque pode despertar
              violências e agressividades. Dessa maneira, é uma emoção que tende
              a ser fortemente temida e desestimulada. O problema disso tudo, é
              que desestimular socialmente uma emoção, não vai fazer com que
              deixemos de senti-la, pois é uma reação, em certa medida, natural
              do nosso sistema nervoso e, além disso, camuflá-la, não nos ensina
              a lidar com ela. E aí sim, podemos agir no impulso, enfurecidos de
          ...
          <BlocoDireita>
            <P>
              ...
              intencionando a fazer.
            </P>
            <P>
              Essa emoção tende a mover de maneira a remover o impedimento e
              mudar a situação atual, frequentemente de modo que destrua ou
              prejudique o alvo, neste caso, o obstáculo (MIGUEL, p.158, 2015).
            </P>
            <P>
              “A raiva surge diante de algum obstáculo que nos frustra ou impede
              as nossas ações (...) Dessa forma, a raiva é a emoção que indica
              que algo está em nosso caminho nos prejudicando de algum modo e
              que, portanto, estaremos motivados para mudar o ambiente e retirar
              esse impedimento” (GONDIN, 2020, p. 79).
            </P>
            <P>
              Ainda, segundo Barros (2020, p.78) as situações que envolvem
              comportamentos de outras pessoas, são as situações que mais
